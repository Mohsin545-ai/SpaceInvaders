...
public class UserDetails extends JPanel {
    ...
    // table column
    private String[] userTableColumn = {"FIRST NAME", "LAST NAME", "HIGHSCORE"};
    ...
    public void getUsers(String[][] objects) {
...
//        }
        ...
        userTable.setModel(new DefaultTableModel(objects,userTableColumn));
    }
